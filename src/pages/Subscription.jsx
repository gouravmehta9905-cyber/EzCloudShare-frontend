...
const Subscription = () => {
  ...
  /*//Fetch the user credits on component mount.
  useEffect(()=>{
          ...
          try{
            ...
            if(verifyResponse.data.success){
              ...
              if(verifyResponse.data.credits){
                ...
                //If credits value is not in the response, refetch the user credits to ensure we have the latest value.
                console.log("Credits value not in response, refetching user credits.");
              ...
              setMessage("Payment verification failed. Please contact support if your payment was successful.");
              setMessageType("error");
            }
          }catch(error){
      ...
      <div className="p-6">
        ...
        {message && ( 
          <div className={`mb-6 p-4 rounded-lg flex items-center gap-3 ${
            messageType === "error" ? "bg-red-50 text-red-700":messageType==="success"?"bg-green-50 text-green-700":"bg-blue-50 text-blue-700"
          }`}>
        ...
        <div className="flex flex-col md:flex-row gap-6 mb-8">
          <div className="bg-blue-50 p-6 rounded-lg">
            ...
            <p className="text-sm text-gray-600 mt-2">
              You can upload {credits ?? 0 }more files with your current credits.
            </p>
          ...
          {plans.map((plan)=>(
            ...
            >   
                ...
                <button 
                      ...
                      className={`w-full py-2 rounded-md font-medium transition-colors ${plan.recommended ? 'bg-purple-500 text-white hover:bg-purple-600 ':'bg-white border border-purple-500  text-purple-500 hover:bg-white disabled:bg-gray-100'} disabled:opacity-50 flex items-center justify-center gap-2`}
                >
                    {processingPayment ?(
                      <> 
        ...
        <div className="mt-8 bg-gray-50 p-4 rounded jborder-gray-200 ">
            <h3 className="font-medium mb-2 ">How credits work </h3>
            <p className="text-sm text-gray-600">
                Each file upload consume 1 credit . New users start with 5 free credits.
