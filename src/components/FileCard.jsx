...
import {Image, Video,Music,FileText,FileIcon,Globe,Lock,Copy,Eye,Download,Trash2} from "lucide-react";
    ...
    <div 
       ...
       <div className={`absolute inset-0 bg-linear-to-t from-black/70 via-black/40 to-transparent flex items-end justify-center p-4 transition-opacity duration-300 ${showActions ? 'opacity-100' : 'opacity-0'}`}>
              <div className="flex gap-3 w-full justify-center ">
                  ...
                  {file.isPublic && (
                        <a href={`/file/${file.id}`} target="_blank" rel="noreferrer" title='View File' className='p-2 bg-white/90 rounded-full hover:bg-white transition-colors text-gray-700 hover:text-gray-900'> 
                                <Eye size={18}/>
